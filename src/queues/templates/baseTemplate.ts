                  ...
                  <table class="email-footer" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="content-cell-footer">
                        <p>
                          This email was sent to you by Joygiver. By using our services, you agree to our
                        </p>
                        <p>
                          <a href="https://helpcenter.com">customer agreements</a>.
                        </p>
                        <p>&copy; Joygiver ${new Date().getFullYear()}. All rights reserved.</p>
                      </td>
                    </tr>
                  </table>
                </td>
